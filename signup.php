...
<section class="forms-section">
    <div class="forms">
      <div class="form-wrapper is-active">
        ...
        <form class="form form-login" method="post" action="signup.php" id="registration-form-vol">
          <fieldset>
          ...
          <button type="submit" value="Register" name="submit" class="btn-login">Register</button>
        ...
        <form class="form form-signup">
            ...
            <div class="column-container">
                ...
                <div class="column1">
                        ...
                        <input id="signup-orgname" type="text" required>
                        ...
                        <div class="input-block">
                            ...
                            <input id="signup-ngoid" type="text" required>
                        ...
                        <div class="input-block">
                            ...
                            <input id="signup-inception" type="text" required>
                ...
                <div class="column2">
                        <div class="input-block">
                            ...
                            <input id="signup-orgcontact" type="text" required>
                        ...
                        <div class="input-block">
                            ...
                            <input id="signup-orgcity" type="text" required>
                ...
                <div class="column3">
                    <div class="input-block">
                        ...
                        <input id="signup-orgemail" type="email" required>
                    </div>
                    
                  <div class="input-block">
                      <label for="signup-orgusername">Username<span class="required">*</span></label>
                      <input id="signup-orgusername" type="text" placeholder="Eg; Smile_fndt" required>
                ...
                <div class="column4">
                    <div class="input-block">
                        ...
                        <input id="signup-orgpassword" type="password" required>
                    ...
                    <div class="input-block">
                        ...
                        <input id="signup-orgconfpassword" type="password" required>
